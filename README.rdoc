...
To use all of this features, do the following:
  ...
  sudo gem install map_by_method what_methods rush english ruby2ruby

Currently what_methods is not running on 1.9 and rush is neither running on 1.9 nor on Rubinius.
