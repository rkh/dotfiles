...
silent only
cd /media/cdrom0/usr/src/linux-2.6.25.16/include/linux
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 blkdev.h
badd +702 /usr/src/linux-source-2.6.24/include/linux/blkdev.h
args blkdev.h /usr/src/linux-source-2.6.24/include/linux/blkdev.h
edit blkdev.h
...
792
normal zo
let s:l = 617 - ((0 * winheight(0) + 20) / 41)
