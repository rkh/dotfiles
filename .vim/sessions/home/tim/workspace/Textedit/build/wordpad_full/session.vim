...
silent only
cd ~/workspace/Textedit/build/wordpad_full
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +358 ~/workspace/Textedit/build/testJampack/TextEdit.jak
badd +0 TextEdit.jak
args ~/workspace/Textedit/build/testJampack/TextEdit.jak TextEdit.jak
edit TextEdit.jak
...
let s:l = 438 - ((33 * winheight(0) + 20) / 41)
