...
silent only
cd ~/workspace/Textedit/build/testJampack
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 TextEdit.jak
badd +0 ~/workspace/Textedit/build/wordpad_full/TextEdit.jak
args TextEdit.jak ~/workspace/Textedit/build/wordpad_full/TextEdit.jak
edit TextEdit.jak
...
let s:l = 358 - ((14 * winheight(0) + 20) / 40)
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 399 - ((42 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
399
