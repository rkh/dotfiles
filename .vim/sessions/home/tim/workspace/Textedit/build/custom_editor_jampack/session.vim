...
silent only
cd ~/workspace/Textedit/build/custom_editor_jampack
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +113 ~/workspace/Textedit/build/custom_editor/TextEdit.jak
badd +0 TextEdit.jak
args ~/workspace/Textedit/build/custom_editor/TextEdit.jak TextEdit.jak
edit TextEdit.jak
...
let s:l = 96 - ((0 * winheight(0) + 21) / 43)
