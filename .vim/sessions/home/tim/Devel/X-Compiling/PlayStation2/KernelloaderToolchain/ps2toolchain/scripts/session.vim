...
silent only
cd ~/Devel/X-Compiling/PlayStation2/KernelloaderToolchain/ps2toolchain/scripts
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 001-binutils-2.14.sh
args 001-binutils-2.14.sh
edit 001-binutils-2.14.sh
