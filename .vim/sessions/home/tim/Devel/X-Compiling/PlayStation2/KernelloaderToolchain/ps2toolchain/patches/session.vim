...
silent only
cd ~/Devel/X-Compiling/PlayStation2/KernelloaderToolchain/ps2toolchain/patches
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 binutils-2.14-PS2.patch
args binutils-2.14-PS2.patch
edit binutils-2.14-PS2.patch
