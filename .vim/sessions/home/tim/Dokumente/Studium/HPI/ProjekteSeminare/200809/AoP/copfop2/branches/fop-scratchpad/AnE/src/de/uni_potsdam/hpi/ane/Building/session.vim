...
silent only
cd ~/Dokumente/Studium/HPI/ProjekteSeminare/200809/AoP/copfop2/branches/fop-scratchpad/AnE/src/de/uni_potsdam/hpi/ane/Building
...
let s:l = 44 - ((22 * winheight(0) + 11) / 23)
