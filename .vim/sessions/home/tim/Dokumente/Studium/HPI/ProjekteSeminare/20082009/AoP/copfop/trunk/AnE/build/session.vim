...
silent only
cd ~/Dokumente/Studium/HPI/Projekte\\Seminare/2008\\2009/AoP/copfop/trunk/AnE
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
args ~/Dokumente/Studium/HPI/ProjekteSeminare/20082009/AoP/copfop/trunk/AnE/build
...
argglobal
enew
file ~/Dokumente/Studium/HPI/ProjekteSeminare/20082009/AoP/copfop/trunk/AnE/build
let s:cpo_save=&cpo
set cpo&vim
...
lcd ~/Dokumente/Studium/HPI/Projekte\\Seminare/2008\\2009/AoP/copfop/trunk/AnE/build
tabnext 1
if exists('s:wipebuf')
