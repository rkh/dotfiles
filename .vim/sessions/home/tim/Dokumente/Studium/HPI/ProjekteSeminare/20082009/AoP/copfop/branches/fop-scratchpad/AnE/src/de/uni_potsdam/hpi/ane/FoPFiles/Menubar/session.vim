...
silent only
cd ~/Dokumente/Studium/HPI/Projekte\\Seminare/2008\\2009/AoP/copfop/branches/fop-scratchpad/AnE/src/de/uni_potsdam/hpi/ane/FoPFiles/Menubar
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +2 TextEdit.jak
badd +0 ~/Dokumente/Studium/HPI/Projekte/Seminare/2008/2009/AoP/copfop/branches/fop-scratchpad/AnE/src/de/uni_potsdam/hpi/ane/FoPFiles/Menubar/
args TextEdit.jak
edit TextEdit.jak
