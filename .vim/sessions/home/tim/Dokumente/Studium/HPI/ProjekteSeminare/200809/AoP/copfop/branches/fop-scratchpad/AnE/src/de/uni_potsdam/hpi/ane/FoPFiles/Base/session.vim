...
silent only
cd ~/Dokumente/Studium/HPI/ProjekteSeminare/200809/AoP/copfop/branches/fop-scratchpad/AnE/src/de/uni_potsdam/hpi/ane/FoPFiles/Base
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 TextEdit.jak
badd +42 ~/Dokumente/Studium/HPI/ProjekteSeminare/200809/AoP/copfop/trunk/AnE/src/de/uni_potsdam/hpi/ane/TextEdit.java
args TextEdit.jak ~/Dokumente/Studium/HPI/ProjekteSeminare/200809/AoP/copfop/trunk/AnE/src/de/uni_potsdam/hpi/ane/TextEdit.java
edit TextEdit.jak
