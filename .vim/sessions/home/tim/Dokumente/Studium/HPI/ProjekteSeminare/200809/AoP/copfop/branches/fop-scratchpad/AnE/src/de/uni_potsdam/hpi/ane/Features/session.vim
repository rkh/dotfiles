...
silent only
cd ~/Dokumente/Studium/HPI/ProjekteSeminare/200809/AoP/copfop/branches/fop-scratchpad/AnE/src/de/uni_potsdam/hpi/ane/Features
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 composer.properties
args composer.properties
edit composer.properties
