...
silent only
cd ~/Dokumente/Studium/HPI/ProjekteSeminare/200809/AoP/copfop/branches/fop-scratchpad/AnE/src/de/uni_potsdam/hpi/ane
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 MainComposition/TextEdit.jak
args MainComposition
edit MainComposition/TextEdit.jak
...
let s:l = 105 - ((42 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
105
normal! 0
lcd ~/Dokumente/Studium/HPI/ProjekteSeminare/200809/AoP/copfop/branches/fop-scratchpad/AnE/src/de/uni_potsdam/hpi/ane
tabnext 1
if exists('s:wipebuf')
