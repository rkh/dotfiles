...
silent only
cd ~/Dokumente/Studium/HPI/ProjekteSeminare/200809/AoP/copfop/branches/fop-scratchpad/AnE/src/de
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 svn-commit.4.tmp
args svn-commit.4.tmp
edit svn-commit.4.tmp
