...
silent only
cd ~/Dokumente/Studium/HPI/ProjekteSeminare/200809/AoP/copfop/branches/fop-scratchpad/AnE/src/de/uni_potsdam/hpi/ane/Building/de
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 TextEdit.java
args TextEdit.java
edit TextEdit.java
...
let s:l = 82 - ((20 * winheight(0) + 20) / 41)
